...
const Products = () => {
  ...
  return (
    <div
      id="products"
      className="flex flex-col 2xl:flex-row gap-[128px] 2xl:gap-2 2xl:justify-between mt-[60px] 2xl:mt-[270px] mb-[160px] max-w-[1490px]
    ...
    >
      ...
      <div className="w-full flex flex-col md:flex-row gap-[60px] md:gap-6">
          ...
          <FadeIn key={i} delay={(i + 1) * 0.2} direction="left" fullWidth>
            <div className="h-[510px] relative flex-1 bg-[#C1D0E4] rounded-[50px] max-w-[500px]">
              <img
                ...
                style={{width:"500px", height:"310px", borderRadius:"50px"}}
              />
              <div className="absolute bottom-0 w-full bg-white h-[180px] rounded-[50px] shadow-md px-8 py-[26px] flex flex-col justify-between">
                <div>
